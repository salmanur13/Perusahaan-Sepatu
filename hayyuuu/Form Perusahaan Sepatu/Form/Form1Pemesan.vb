Public Class Form1Pemesan
    ...
    Private Sub BtnInput_Click_1(sender As Object, e As EventArgs) Handles BtnInput.Click 'input
        Dim pesan As New Pesanan(txtKode.Text, TxtNama.Text, DateTimePicker1.Text, TxtNo.Text, TxtAlamat.Text, ComboBoxMerk1.Text, ComboBoxWarna1.Text, ComboBoxUk1.Text, txtJ1.Text, txtV.Text, txtA.Text, txtN.Text)
        pesan.savedata()
        ListView1.Items.Clear()
        For Each pesan In Pesanan.dataPesanan
