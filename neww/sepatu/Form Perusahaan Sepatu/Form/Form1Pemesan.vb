Public Class Form1Pemesan 'class public Form1Pemesan
    ...
    Private Sub BtnInput_Click_1(sender As Object, e As EventArgs) Handles BtnInput.Click 'menjalankan fungsi BtnSelesai
        ...
        Dim pesanan As New Pesanan(txtKode.Text, TxtNama.Text, DateTimePicker1.Text, TxtNo.Text, TxtAlamat.Text, ComboBoxMerk1.Text, ComboBoxWarna1.Text, ComboBoxUk1.Text, txtJ1.Text, txtV.Text, txtA.Text, txtN.Text)
        ...
        For Each pesan In Penyimpanan.dataPesanan
            ListView1.Items.Add(New ListViewItem(New String() {pesan.Kode, pesan.Nama, pesan.Tanggal, pesan.No, pesan.Alamat, pesan.ItemPesanan, pesan.Jumlah}))
        Next
        'kode pesanan
    ...
    Private Sub BtnHitung_Click(sender As Object, e As EventArgs) Handles BtnHitung.Click
        Dim Harga As Integer 'mendeklarasikan harga sebagai integer
        Select Case ComboBoxMerk1.Text
            ...
            Case "Heels"
                Harga = "Rp" & 125000
        End Select
        txtTotal.Text = Harga * txtJ1.Text 'menginisialisasi txtTotal.Text = Harga * txtJ1.Text
    End Sub
