Public Class Pesanan
    ...
    Sub New(Kode As String, Nama As String, Tanggal As String, No As String, Alamat As String, MerkPesanan As String, WarnaPesanan As String, UkuranPesanan As String, jumlah As Integer, tpV As String, tpA As String, tpN As String)
        Me.Jumlah = jumlah
        Me.Kode = Kode
        Me.Nama = Nama
        Me.Tanggal = Tanggal
